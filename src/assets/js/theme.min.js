...
! function() {
    ...
    t && [].forEach.call(t, function(t) {
      t.addEventListener("click", function(e) {
        e.preventDefault(), e.stopPropagation(),
          function(e) {
            var t = e.closest(".dropdown-menu").querySelectorAll(".dropdown-menu"),
              n = e.parentElement.querySelector(".dropdown-menu");
            [].forEach.call(t, function(e) {
  ...
  function() {
    ...
    e && [].forEach.call(e, function(e) {
      ...
      t.on("show.bs.collapse", function() {
        ! function(e) {
          e.closest(".faq").find(".collapse").not(e).collapse("hide")
        }(t)
      })
    })
  }(),
  ...
  function() {
    ...
    e && [].forEach.call(e, function(e) {
      ! function(e) {
        var t = parseInt(e.getAttribute("data-zoom")),
          n = JSON.parse(e.getAttribute("data-markers")),
          o = {
            lat: n[0][0],
            lng: n[0][1]
          },
  ...
  function() {
    ...
    $(e).on("shown.bs.modal hide.bs.modal", function(e) {
      ...
      t && "shown" == e.type ? function(e) {
        e.play()
      }(t) : t && "hide" == e.type && function(e) {
        e.pause()
      }(t)
    })
  }(),
  ...
  function() {
    var t = document.querySelector("#mc-embedded-subscribe-form"),
      n = document.querySelector("#mce-EMAIL"),
      e = document.querySelectorAll(".form-mailchimp-clone"),
      o = document.querySelectorAll('.form-mailchimp-clone input[type="email"]'),
          ...
          $.ajax({
            ...
            success: function(e) {
              if ("success" != e.result) {
                ...
                window.dispatchEvent(t)
              } else t = new CustomEvent("alert.show", {
                detail: {
                  type: "success",
                  message: e.msg
                }
    ...
    e && [].forEach.call(e, function(e) {
      ! function(e) {
        new Flickity(e, {
          ...
          cellAlign: "left",
          contain: !0,
          draggable: !e.classList.contains("slider-no-draggable"),
          fade: e.classList.contains("slider-fade"),
          imagesLoaded: !0,
          pageDots: !1,
          prevNextButtons: !e.classList.contains("slider-no-controls"),
          wrapAround: !0
        })
      }(e)
        ...
        e.preventDefault(),
          function(e) {
            var t = e.getAttribute("data-slide"),
              n = e.getAttribute("data-target") ? e.getAttribute("data-target") : e.getAttribute("href"),
              o = document.querySelector(n),
              a = Flickity.data(o);
            "previous" == t ? a.previous() : "next" == t && a.next()
          }(this)
      })
